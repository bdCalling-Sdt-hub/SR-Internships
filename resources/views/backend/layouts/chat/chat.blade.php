...
@section('content')
                    ...
                    <div class="chat-box">
                        ...
                        <form id="chat-input-form" class="chat-input-form" action="{{ route('messages.send') }}"
                            ...
                            <div class="common-class d-flex align-items-center">
                                <i class="bi bi-camera image-icon" data-bs-target="#exampleModalToggle" data-bs-toggle="modal"></i>
    ...
    <script>
        ...
        //     // console.log(users)
        // const userListContainer = document.querySelector('.chat-list .users');
    ...
    //         <div class="chat-item">
    //                 <img src="/avatars/man.png" alt="${user.name}" class="avatar">
    //                 <h6>${user.name}</h6>
    //             </div>
    //     `;
